...
sed -i 's/{===>} structures_0=1000;/{===>} structures_0=100;/g' run.cns
sed -i 's/{===>} structures_1=200;/{===>} structures_1=20;/g' run.cns
sed -i 's/{===>} anastruc_1=200;/{===>} anastruc_1=20;/g' run.cns
sed -i 's/{===>} waterrefine=200;/{===>} waterrefine=20;/g' run.cns
...
sed -i "s/cutnb=15.0/cutnb=$CUTNB/g" protocols/read_struc.cns
sed -i "s/ctofnb=14.0/ctofnb=$CTOFNB/g" protocols/read_struc.cns
sed -i "s/ctonnb=12.0/ctonnb=$CTONNB/g" protocols/read_struc.cns

sed -i "s/cutnb=9.5/cutnb=$CUTNB/g" protocols/read_struc.cns
sed -i "s/ctofnb=8.5/ctofnb=$CTOFNB/g" protocols/read_struc.cns
sed -i "s/ctonnb=6.5/ctofnb=$CTONNB/g" protocols/read_struc.cns
